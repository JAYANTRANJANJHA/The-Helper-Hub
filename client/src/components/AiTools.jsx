    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            <div className='text-center'>
                <h2 className='text-slate-600 text-[42px] font-semibold'> One Hub Every Task </h2>
                <p className='text-gray-500 max-w-lg mx-auto'>Get instant access to a curated collection of powerful tools. Whether you need AI assistance or a simple utility, it's all right here in a single, easy-to-use platform.</p>
            </div>
