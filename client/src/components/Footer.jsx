       ...
       <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    <img className="h-9" src={assets.logo} alt="thehelpinghub" />
                    <p className="mt-6 text-sm">
                        Unlock your full potential with The Helper Hub. <br />
Streamline any task with our unified suite of smart tools. From AI assistance to everyday utilities, we're here to enhance your workflow.
                    </p>
                </div>
