...
const Testimonial = () => {
    const dummyTestimonialData = [
    {
        ...
        name: 'Shivesh Navin',
        title: 'SDE 3, PayPal',
        content: 'The Helper Hub has become my go-to. I\'ve replaced at least five different apps with this one toolkit. The time savings are incredible.',
        rating: 4,
    },
    {
        ...
        name: 'Shivam Jha',
        title: 'Engineer, Uber',
        content: 'What I love is the seamless mix of AI and standard utilities. I can go from generating code snippets to formatting JSON without ever leaving the app.',
        rating: 5,
    },
    {
        image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&h=200&auto=format&fit=crop",
        name: 'Manohar Thakur',
        title: 'Syneos Health, Developer',
        content: 'This tool has genuinely simplified my development workflow. Having everything from a text converter to an AI assistant in one hub is a game-changer.',
        rating: 4,
    }
]
